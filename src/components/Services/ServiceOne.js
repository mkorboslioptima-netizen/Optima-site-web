        ...
        <div className="relative z-10 mx-auto theme-container">
          <div className="w-full xl:py-[130px] py-[60px] xl:px-[80px] md:px-10 px-5 bg-main-gray rounded-[10px] border border-[#e7e3fa]">
            <div className="flex flex-col items-center">
              <span className="text-buisness-red font-medium px-5 py-3 border border-[#e7e3fa] leading-none rounded-full inline-block mb-5 bg-white">
                Nos Services
              </span>
              <h2 className="md:text-40 text-34 font-semibold text-main-black mb-[50px] text-center lg:w-[685px] w-full">
                Des outils puissants pour chaque aspect de votre entreprise
              </h2>
            </div>
            <div className="w-full grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:gap-[70px] gap-8">
              <div
                data-aos="zoom-in-left"
                className="flex flex-col space-y-[30px] justify-between items-center rounded-[10px] bg-white px-8 py-10 hover:shadow-common group border border-transparent hover:border-buisness-red common-transition"
              >
                <div className="w-[60px] h-[60px] flex justify-center items-center rounded-full bg-[#e7e3fa] group-hover:bg-buisness-red common-transition text-buisness-red group-hover:text-white">
                  <span>
                    <svg
                      width="30"
                      height="30"
                ...
                <div>
                  ...
                  <p className="text-center text-paragraph">
                    La solution de gestion intégrée pour piloter votre entreprise avec efficacité.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-center text-paragraph">
                    solutions de gestion des temps et plannings, optimisez la productivité de votre équipe.
                  </p>
                </div>
              </div>
              <div
