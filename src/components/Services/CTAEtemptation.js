      ...
      <div className="w-full mx-auto theme-container">
        <div className="max-w-4xl mx-auto text-center" data-aos="zoom-in">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link to="/devis">
              <button className="group flex items-center gap-3 px-8 py-4 bg-white text-buisness-red font-bold rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-xl hover:shadow-2xl text-lg">
                Demander une Démo
            ...
            <Link to="/contact">
              <button className="px-8 py-4 bg-white/20 border-2 border-white text-white font-bold rounded-lg hover:bg-white/30 transition-all duration-300 text-lg">
                Nous Contacter
              </button>
            </Link>
          </div>
