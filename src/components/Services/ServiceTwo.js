      ...
      <div className="relative z-10 w-full mx-auto theme-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[30px] mt-7 md:mt-[70px]">
          ...
          <div
            ...
            data-aos="fade-left"
            className="col-span-1 p-5 md:p-[50px] rounded-3xl flex flex-col md:flex-row gap-[50px] relative overflow-hidden group border border-gray-200 transition-all duration-300 before:inline-block before:w-[1000px] before:h-[1000px] before:rounded-full before:bg-buisness-red before:absolute before:z-0 z-10 before:-bottom-[1000px] before:-right-[1000px] before:transition-all before:duration-1000 hover:before:-bottom-[300px] hover:before:-right-[100px] shadow-sm"
          >
            {/* <!-- animation circle  --> */}
             ...
             Gérez l'intégralité de votre cycle de vente, du devis à la facturation, avec une fluidité exceptionnelle.
              ...
              <Link to="/service-details">
                <div className="flex items-center gap-2 mt-4 group">
                  <span className="relative font-medium leading-5 transition-all duration-300 text-buisness-red group-hover:text-white border-b border-transparent font-inter before:inline-block before:border-white before:border-b before:absolute before:bottom-0 before:transition-all before:duration-300 before:w-0 hover:before:w-full before:overflow-hidden before:h-5">
                    En savoir plus
                  </span>
                  <svg
                    width="7"
              ...
              <Link to="/service-details">
                <div className="flex items-center gap-2 mt-4 group">
                  ...
                  >
                    <path
                      className="transition-all duration-300 group-hover:stroke-white"
                      d="M1.5 10L5.29289 6.70711C5.62623 5.87377 5.79289 5.70711 5.79289 5.5C5.79289 5.29289 5.62623 5.12623 5.29289 4.79289L1.5 1"
                      stroke="#D90A2C"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
